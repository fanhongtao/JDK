 ...
 */
class SynthComboBoxUI extends ComboBoxUI implements SynthUI,
    ...
    public void installUI( JComponent c ) {
        ...
        popup = createPopup();
        popup.setName("ComboPopup.popup");
        installDefaults();
    ...
    private void fetchStyle(JComboBox comboBox) {
    ...
    protected SynthComboPopup createPopup() {
        ...
        // PENDING: this needs to change, we should NOT trigger loading
        // the accessible here.
     ...
     * <code>BasicComboBoxUI</code>.
     */
    class ComboBoxLayoutManager implements LayoutManager {
        ...
        public void layoutContainer(Container parent) {
            ...
            if ( arrowButton != null ) {
	        if(SynthLookAndFeel.isLeftToRight(cb)) {
    ...
    protected JButton createArrowButton() {
        return new SynthArrowButton(SwingConstants.SOUTH);
    }
	...
	if(SynthLookAndFeel.isLeftToRight(comboBox)) {
	...
	SwingUtilities.replaceUIInputMap(comboBox, JComponent.
        ...
        LazyActionMap.installLazyActionMap(comboBox, this);
    }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ( comboBox.isPopupVisible() ) {
                    // PENDING: getUI() change
		    SynthComboBoxUI ui = (SynthComboBoxUI)comboBox.getUI();
     ...
     */
    static class SynthComboBoxRenderer extends JLabel implements ListCellRenderer, UIResource {
        ...
        public Component getListCellRendererComponent(JList list, Object value,
            ...
            // PENDING: There needs to be a way to alter the selected state
            // of the UI.
