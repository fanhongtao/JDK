/*
 * @(#)GTKTransferable.java	1.2 03/01/23
 *
 ...
 */
class GTKTransferable implements Transferable, UIResource {
	...
	try {
	    ...
	    System.err.println("error initializing com.sun.java.swing.plaf.gtk.GTKTranserable");
	}
    }
    
    public GTKTransferable(String plainData, String htmlData) {
