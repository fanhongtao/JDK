/*
 * @(#)SynthTableUI.java	1.12 03/01/23
 *
 ...
 *
 * @version 1.12, 01/23/03 (based on BasicTableUI v 1.122)
 * @author Philip Milne
 */
class SynthTableUI extends TableUI implements SynthUI {
...
//  Installation
    ...
    private void fetchStyle(JTable c) {
    ...
    protected void installKeyboardActions() {
        LazyActionMap.installLazyActionMap(table, SynthTableUI.class,
                                           "Table.actionMap");
...
//
	...
	paintCells(context, g, rMin, rMax, cMin, cMax);
        ...
        // PENDING: We may want to add a special Renderer for painting
	...
	Rectangle maxCell = table.getCellRect(rMax, cMax, true);
        ...
        SynthGraphics synthG = context.getStyle().getSynthGraphics(context);
     ...
     */
    static class TableDragGestureRecognizer extends SynthDragGestureRecognizer {
     ...
     */
    static class TableDropTargetListener extends SynthDropTargetListener {
     ...
     * varaible based on what changes.
     */
	...
	public void propertyChange(PropertyChangeEvent event) {
	    String changeName = event.getPropertyName();
            ...
            if (SynthLookAndFeel.shouldUpdateStyle(event)) {
                fetchStyle((JTable)event.getSource());
            }
