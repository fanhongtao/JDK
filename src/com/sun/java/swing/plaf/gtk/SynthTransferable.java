/*
 * @(#)SynthTransferable.java	1.2 03/01/23
 *
 ...
 * @version 1.2 01/23/03 (based on revision 1.7 of BasicTransferable)
 */
class SynthTransferable implements Transferable, UIResource {
    ...
    public SynthTransferable(String plainData, String htmlData) {
