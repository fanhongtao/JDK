/*
 * @(#)TransientBindingIterator.java	1.43 03/01/23
 *
...
import com.sun.corba.se.internal.CosNaming.InternalBindingValue;
...
public class TransientBindingIterator extends BindingIteratorImpl
{
     ...
     * initialize.
   */
    public TransientBindingIterator(org.omg.CORBA.ORB orb, Hashtable aTable,
        POA thePOA )
