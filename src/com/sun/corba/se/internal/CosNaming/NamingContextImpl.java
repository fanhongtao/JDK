/*
 * @(#)NamingContextImpl.java	1.65 03/01/23
 *
...
import com.sun.corba.se.internal.corba.InitialNamingClient;
    ...
    implements NamingContextDataStore
{
     ...
     */
    public NamingContextImpl(POAORB orb, POA poa) throws java.lang.Exception {
	super();
	this.orb = orb;
   ...
   */
    ...
    */ 
    ...
    transient protected org.omg.CORBA.ORB orb;
