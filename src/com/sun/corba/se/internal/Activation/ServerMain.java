...
class ServerCallback extends 
    com.sun.corba.se.ActivationIDL._ServerImplBase
{
    private ORB orb;
	...
	// XXX We really need to shutdown ALL of the ORBs here.
	// Since there is no way to do this automatically, allow
	// user to write code to handle this.
