/*
 * @(#)NamingContextImpl.java	1.15 03/01/23
 *
    ...
    implements NamingContextDataStore, Serializable 
{
    ...
    private transient com.sun.corba.se.internal.CosNaming.InterOperableNamingImpl insImpl;
    ...
    public NamingContextImpl(POAORB orb, String objKey, 
	...
	insImpl = 
            new com.sun.corba.se.internal.CosNaming.InterOperableNamingImpl(); 
	
    }

    com.sun.corba.se.internal.CosNaming.InterOperableNamingImpl getINSImpl( )
    {
	if( insImpl == null )
	{
    ...
    public void setORB( POAORB theOrb ) {
	orb = theOrb;
    }
   ...
   */
   public void bind(NameComponent[] n, org.omg.CORBA.Object obj)
               ...
               org.omg.CosNaming.NamingContextPackage.AlreadyBound
    {
        if( obj == null )
        {
                throw new org.omg.CORBA.INTERNAL(MinorCodes.OBJECT_IS_NULL,
 ...
 /**
                     ...
                     org.omg.CosNaming.NamingContextPackage.InvalidName
    {
        ...
        try {
            ...
            throw new org.omg.CORBA.INTERNAL(
                MinorCodes.NAMING_CTX_REBIND_ALREADY_BOUND,
                CompletionStatus.COMPLETED_NO);
        }
    }
   ...
   public  void rebind_context(NameComponent[] n, NamingContext nc)
               ...
               org.omg.CosNaming.NamingContextPackage.InvalidName
    {
        try {
            ...
            // This should not happen
            throw new org.omg.CORBA.INTERNAL(
                MinorCodes.NAMING_CTX_REBINDCTX_ALREADY_BOUND,
                CompletionStatus.COMPLETED_NO);
        }
    }
   ...
   */
    ...
    // At bottom level?
      ...
      // How should we propagate the bind
            ...
            default:
                // This should not happen
                throw new org.omg.CORBA.INTERNAL(MinorCodes.NAMING_CTX_BAD_BINDINGTYPE,
                CompletionStatus.COMPLETED_NO);
            }
        }
    }
   ...
   */
	...
	try
	{
		if( bt.value() == BindingType._nobject )
		{
			...
			value = new InternalBindingValue(bt,
		...
		else
		{
			...
			// from the NameService and store it in the Internal Binding Value instance
                        String theNCKey = theNameServiceHandle.getObjectKey(
								 obj );
			value = new InternalBindingValue( bt,
                                            theNCKey );
		        value.setObjectRef( obj );
		...
		else
		{
			try
			{
				...
				theServantManagerImplHandle.updateContext( objKey,
		                                           this );
			}
			catch( Exception e )
			{
				...
				(int)	3,  // Replace this with a valid constant
	...
	catch( Exception e )
	{
		...
		throw new org.omg.CORBA.UNKNOWN( 
			3,  // Replace this with a valid constant
	       		CompletionStatus.COMPLETED_MAYBE );
	}
    }
   ...
   */
	...
	try
	{
		...
		{ 
			...
			if( theObjectFromStringifiedReference == null )
			{
				...
				{
					// Throw Invalid Reference Exception
					throw new org.omg.CORBA.UNKNOWN( 
					3,  // Replace this with a valid constant
			        	CompletionStatus.COMPLETED_MAYBE );
				}
	...
	{
		// Something wrong happened while resolving the given NameComponent,
		// So, Speak the UNKNOWN error
		throw new org.omg.CORBA.UNKNOWN( 
				3,  // Replace this with a valid constant
		        	CompletionStatus.COMPLETED_MAYBE );
	}
   ...
   */
	...
	{
		// Add a new Minor code for Unbind exception
		throw new org.omg.CORBA.UNKNOWN( 
				3,  // Replace this with a valid constant
		        	CompletionStatus.COMPLETED_MAYBE );
	} 
   ...
   */
	...
	{
			throw new org.omg.CORBA.INTERNAL(
			MinorCodes.TRANS_NC_NEWCTX_GOT_EXC,
			CompletionStatus.COMPLETED_NO);
   ...
   */
	...
	{
			//throw new org.omg.CORBA.INTERNAL(
			//MinorCodes.TRANS_NC_DESTROY_GOT_EX,
			//CompletionStatus.COMPLETED_NO );
    ...
    */
               ...
               org.omg.CosNaming.NamingContextPackage.InvalidName
    {
        ...
        try {
            corbaName = ((com.sun.corba.se.internal.corba.ORB)orb).
                getInitialNamingClient().checkcorbanameGrammer(
                urlBasedAddress );
        } catch( BAD_PARAM e ) {
            throw new
