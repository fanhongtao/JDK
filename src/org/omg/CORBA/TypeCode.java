...
public abstract class TypeCode implements IDLEntity {
   ...
   * @exception org.omg.CORBA.TypeCodePackage.BadKind if the method
   ...
   * @exception org.omg.CORBA.TypeCodePackage.Bounds if the index is equal
   *            to or greater than
