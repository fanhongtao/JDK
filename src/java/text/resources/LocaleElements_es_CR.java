/*
 * @(#)LocaleElements_es_CR.java	1.2 98/01/13
 *
...
public class LocaleElements_es_CR extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_CR" }, // locale id based on iso codes
            { "LocaleID", "140a" }, // Windows id
            { "ShortCountry", "CRI" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
