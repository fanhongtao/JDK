/*
 * @(#)LocaleElements_es_VE.java	1.2 98/01/13
 *
...
public class LocaleElements_es_VE extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_VE" }, // locale id based on iso codes
            { "LocaleID", "200a" }, // Windows id
            { "ShortCountry", "VEN" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "Bs#,##0.00;Bs -#,##0.00", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "CurrencyElements", 
                new String[] { 
                    "Bs", // local currency symbol
                    "VEB", // intl currency symbol
