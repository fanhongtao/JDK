/*
 * @(#)LocaleElements_sr.java	1.10 98/01/13
 *
...
public class LocaleElements_sr extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "sr_YU" }, // locale id based on iso codes
            { "LocaleID", "0c1a" }, // Windows id
            ...
            { "NumberPatterns",
                new String[] {
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "'\u0414\u0438\u043d' #,##0.00;-'\u0414\u0438\u043d' #,##0.00", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "NumberElements",
