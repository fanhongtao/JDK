/*
 * @(#)LocaleElements_zh_TW.java	1.10 98/01/13
 *
...
public class LocaleElements_zh_TW extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "zh_TW" }, // locale id based on iso codes
            { "LocaleID", "0404" }, // Windows id
            { "ShortCountry", "TWN" }, // iso-3 abbrev country name
            { "Eras",
