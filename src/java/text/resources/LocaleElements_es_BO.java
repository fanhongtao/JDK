/*
 * @(#)LocaleElements_es_BO.java	1.2 98/01/13
 *
...
public class LocaleElements_es_BO extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_BO" }, // locale id based on iso codes
            { "LocaleID", "400a" }, // Windows id
            { "ShortCountry", "BOL" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
