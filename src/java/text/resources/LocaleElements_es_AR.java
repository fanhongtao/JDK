/*
 * @(#)LocaleElements_es_AR.java	1.2 98/01/13
 *
...
public class LocaleElements_es_AR extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_AR" }, // locale id based on iso codes
            { "LocaleID", "2c0a" }, // Windows id
            { "ShortCountry", "ARG" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
