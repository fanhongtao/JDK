/*
 * @(#)LocaleElements_be.java	1.10 01/12/10
 *
...
public class LocaleElements_be extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "be_BY" }, // locale id based on iso codes
            { "LocaleID", "0423" }, // Windows id
            { "ShortLanguage", "bel" }, // iso-3 abbrev lang name
            { "ShortCountry", "BLR" }, // iso-3 abbrev country name
            ...
            { "CurrencyElements",
                new String[] {
                    "\u0420\u0443\u0431", // local currency symbol
                    "BYB", // intl currency symbol
