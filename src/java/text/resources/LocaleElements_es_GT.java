/*
 * @(#)LocaleElements_es_GT.java	1.2 98/01/13
 *
...
public class LocaleElements_es_GT extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_GT" }, // locale id based on iso codes
            { "LocaleID", "100a" }, // Windows id
            { "ShortCountry", "GTM" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "Q#,##0.00;(Q#,##0.00)", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "NumberElements", 
            ...
            { "CurrencyElements", 
                new String[] { 
                    "Q", // local currency symbol
                    "GTQ", // intl currency symbol
