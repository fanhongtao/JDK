/*
 * @(#)LocaleElements_es_UY.java	1.2 98/01/13
 *
...
public class LocaleElements_es_UY extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_UY" }, // locale id based on iso codes
            { "LocaleID", "380a" }, // Windows id
            { "ShortCountry", "URY" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "NU$ #,##0.00;(NU$#,##0.00)", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "CurrencyElements", 
                new String[] { 
                    "NU$", // local currency symbol
                    "UYU", // intl currency symbol
