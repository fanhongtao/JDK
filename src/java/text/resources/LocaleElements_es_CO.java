/*
 * @(#)LocaleElements_es_CO.java	1.2 98/01/13
 *
...
public class LocaleElements_es_CO extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_CO" }, // locale id based on iso codes
            { "LocaleID", "240a" }, // Windows id
            { "ShortCountry", "COL" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
