/*
 * @(#)LocaleElements_en_ZA.java	1.2 98/01/13
 *
...
public class LocaleElements_en_ZA extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "en_ZA" }, // locale id based on iso codes
            { "LocaleID", "1c09" }, // Windows id
            { "ShortCountry", "ZAF" }, // iso-3 abbrev country name
            ...
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "R #,##0.00;R-#,##0.00", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "CurrencyElements", 
