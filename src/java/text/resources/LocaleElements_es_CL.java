/*
 * @(#)LocaleElements_es_CL.java	1.2 98/01/13
 *
...
public class LocaleElements_es_CL extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_CL" }, // locale id based on iso codes
            { "LocaleID", "340a" }, // Windows id
            { "ShortCountry", "CHL" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "Ch$#,##0.00;Ch$-#,##0.00", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "CurrencyElements", 
                new String[] { 
                    "Ch$", // local currency symbol
                    "CLP", // intl currency symbol
