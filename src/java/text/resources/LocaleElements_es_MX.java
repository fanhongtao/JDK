/*
 * @(#)LocaleElements_es_MX.java	1.2 98/01/13
 *
...
public class LocaleElements_es_MX extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_MX" }, // locale id based on iso codes
            { "LocaleID", "080a" }, // Windows id
            { "ShortCountry", "MEX" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
