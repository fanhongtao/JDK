/*
 * @(#)LocaleElements_en_AU.java	1.3 98/01/13
 *
...
public class LocaleElements_en_AU extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "en_AU" }, // locale id based on iso codes
            { "LocaleID", "0c09" }, // Windows id
            { "ShortCountry", "AUS" }, // iso-3 abbrev country name
