/*
 * @(#)LocaleElements_es_PE.java	1.2 98/01/13
 *
...
public class LocaleElements_es_PE extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_PE" }, // locale id based on iso codes
            { "LocaleID", "280a" }, // Windows id
            { "ShortCountry", "PER" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
