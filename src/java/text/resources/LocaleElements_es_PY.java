/*
 * @(#)LocaleElements_es_PY.java	1.2 98/01/13
 *
...
public class LocaleElements_es_PY extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_PY" }, // locale id based on iso codes
            { "LocaleID", "3c0a" }, // Windows id
            { "ShortCountry", "PRY" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "G#,##0.00;(G#,##0.00)", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "CurrencyElements", 
                new String[] { 
                    "G", // local currency symbol
                    "PYG", // intl currency symbol
