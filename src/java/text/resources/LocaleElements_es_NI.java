/*
 * @(#)LocaleElements_es_NI.java	1.2 98/01/13
 *
...
public class LocaleElements_es_NI extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_NI" }, // locale id based on iso codes
            { "LocaleID", "" }, // Windows id
            { "ShortCountry", "NIC" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
