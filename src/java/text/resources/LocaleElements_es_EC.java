/*
 * @(#)LocaleElements_es_EC.java	1.2 98/01/13
 *
...
public class LocaleElements_es_EC extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_EC" }, // locale id based on iso codes
            { "LocaleID", "300a" }, // Windows id
            { "ShortCountry", "ECU" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "S/#,##0.00;S/-#,##0.00", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "NumberElements", 
