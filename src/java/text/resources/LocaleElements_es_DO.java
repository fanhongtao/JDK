/*
 * @(#)LocaleElements_es_DO.java	1.2 98/01/13
 *
...
public class LocaleElements_es_DO extends ListResourceBundle {
    ...
    public Object[][] getContents() {
        return new Object[][] {
            { "LocaleString", "es_DO" }, // locale id based on iso codes
            { "LocaleID", "1c0a" }, // Windows id
            { "ShortCountry", "DOM" }, // iso-3 abbrev country name
            { "NumberPatterns", 
                new String[] { 
                    "#,##0.###;-#,##0.###", // decimal pattern
                    "RD$#,##0.00;(RD$#,##0.00)", // currency pattern
                    "#,##0%" // percent pattern
                }
            },
            { "NumberElements", 
            ...
            { "CurrencyElements", 
                new String[] { 
                    "RD$", // local currency symbol
                    "DOP", // intl currency symbol
